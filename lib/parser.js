...
var parser = {
	...
	getBrokenReferences: function() {
		...
		.then(self.getCorrectedPathsForMovedFiles.bind(self))
		.then(function() {
			return {
	...
	getRelativePathOfReference: function(pathOfReferencingFile, pathReferenced) {
		if (!this.existingFiles[pathOfReferencingFile]) {
			return '';
		}
	...
	getCorrectPathForDuplicateFilename: function(brokenReference) {
		...
		// If file was moved, determine its directory-levefl relationship to other referenced files
...
module.exports = {
	...
	getRelativePathOfReference: parser.getRelativePathOfReference.bind(parser)
};