...
var updater = {
	...
	getCorrectPathForDuplicateFilename: function(brokenReference) {
		...
		console.log("movedReferencingFile", movedReferencingFile);
		var correctedPath = null;
		if (movedReferencingFile) {
			var originalPathOfMovedReferencingFile = movedReferencingFile.referencedFile;
			console.log('originalPathOfMovedReferencingFile', originalPathOfMovedReferencingFile);
		...
		console.log('correct path', brokenReference.correctPath);
