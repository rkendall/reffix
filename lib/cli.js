...
var cli = {
	...
	parseCommandLine: function() {
		...
		program
			...
			.option('-s, --sources [file_glob]', 'List the files (sources of references) that contain references to other files. File filter is optional.')
			.option('-t, --targets [file_glob]', 'List the files (targets of references) that are referenced by other files. File filter is optional.')
