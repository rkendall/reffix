...
var cli = {
	...
	parseCommandLine: function() {
		...
		program
			...
			.option('-d, --dir <directory>', 'Comma-separated list of directories to exclude from parsing. Quotes required. (e.g., \'test,bin\')')
	...
	getMultipleArgsForOptions: function() {
		...
		program.rawArgs.forEach(function(arg, ind) {
			...
			} else if (ind === program.rawArgs.length - 1) {
